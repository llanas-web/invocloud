...
-- Supprimer les colonnes Stripe de establishments seulement si elles existent
DO $$
BEGIN
  -- stripe_customer_id
  IF EXISTS (
...
-- Ajouter has_been_measured seulement si elle n'existe pas
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 
    ...
    WHERE table_name = 'invoices' 
      AND column_name = 'has_been_measured'
      AND table_schema = 'public'
  ) THEN
