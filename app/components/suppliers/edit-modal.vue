...
const { openModal: open, formState, isLoading, emailField, addEmail, onSubmit } = useSupplierEdit();
            ...
            <UForm :state="formState" class="space-y-4" @submit="onSubmit">
                ...
                <div class="flex justify-end gap-2">
                    <UButton label="Annuler" color="neutral" variant="subtle" @click="open = false"
                        :disabled="isLoading" />
                    <UButton label="Modifier" color="primary" variant="solid" type="submit" :loading="isLoading" />
                </div>
            </UForm>
        </template>
    </UModal>
